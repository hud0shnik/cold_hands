...
## Убирает подтверждение выхода (я наконец-то нашёл как это сделать) >:^P
...
define config.name = _("Холодные руки")
...
Данина электруха \n
{b}Звуки: {/b} \n
    Данин конденсаторный микрофон \n
{b}Визуальное оформление (Gui): {/b} \n
    Данин графический планшет\n
{b}Сценарий: {/b} \n
    Данина голова

    \n\n
Любые сходства с реальным миром - совпадение. Все персонажи выдуманы. Алкоголь - яд. Наркотики - зло. Социализм - сила.\n
""")
...
define config.main_menu_music = "music/cold_hands.mp3"
...
default preferences.text_cps = 13
...
define config.save_directory = "cold_hands-1649540746"
...
# define build.itch_project = "hud0shnik/cold_hands"
