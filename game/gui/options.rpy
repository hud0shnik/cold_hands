...
define gui.about = _p("""
Мой первый проект в этой сфере. Любые сходства с реальным миром - совпадение. Все персонажи выдуманы. На гитаре играю я, некоторые звуки тоже записывал я.
Но так как имею всего лишь две гитары и один микрофон, должен написать следующее
\n
{b}Музыка и звуки: {/b} \n
    https://freesfx.co.uk/\n
