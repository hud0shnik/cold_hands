...
label v3_s1:
    ...
    "Ну, да, приносить жизнь в жертву ради идеи и прочее тоже стоит рассматривать, но это не мой путь."
...
label v3_s2:
    ...
    y "Ой, ну не знаю, всегда говорила без пятнадцати десять."
    ...
    D "Да ладно тебе, мы же не в клуб настольных игр идём."
...
label v3_s4:
    ...
    D "Думаю устроиться в пекарню консультантом по чаям, на следующей неделе собеседование."
    ...
    "Просто прекрасный ход даже для меня."
...
label v3_s5:
    ...
    play sound door
    show sn 1-5 at right2 with moveinright
    s "Ой, я вам помешал, да?"
    s 3-5 "Мы собираемся поехать в бар, вы с нами?"
    ...
    show sn 1-1 at right with dissolve
    show nm 0 at left2 with dissolve
    show nf 0 at right2 with dissolve
    s "Так, все в сборе?"
    nm "Конечно в сборе!"
    ...
    s 3-2 "Так, я пойду провожу Даню, а вы пока ждите тут."
    D "Всем пока."
    nm "Пока."
    nf "Давай."
    hide nm with moveoutleft
    show a 0 at left2 with moveinleft
    a "Пока, Дань."
    ...
    s 3-4 "Быстро ты. Молодца!"
    D "Пока не забыл, забей её на быстрый набор."
    s 2-4 "А, да, точно, секунду."
    "..."
    s "Всё, поставил её на четвёрочку."
    D "Спасибо."
    s 1-1 "Да не за что."
    play sound door
    show y 1-1 at left2 with fade
    show sn 2-1 at right2 with moveinleft
    y "Уже пришли?"
    D "Ага."
    y "Саш, поздравляю с победой!"
    s 1-1 "Хех, спасибо."
    s "Ладно, я пойду."
    D "Пока, Сань."
    y "Удачи."
...
label v3_s6:
    ...
    y 1-7 "Как посидели?"
    D "Неплохо, успел даже познакомиться с одной девушкой."
    y 3-0 "Ого, кто-то решил серьёзно заняться личной жизнью?"
    D "Максимализм этот твой ..."
    y 1-7 "Да ладно тебе, шучу, просто шучу."
    y "А она не против того, что ты с подругой живёшь?"
    D "Да господи, мы только один день знакомы."
    "Я сел на кресло в гостиной."
    D "Если серьёзно, то я даже взял у неё номер телефона."
    y 1-1 "Быстро ты ..."
    y 2-1 "Ой, тебе наверное забить его надо на кнопку?"
    D "Саня уже забил."
    y 1-1 "Когда знакомить будешь?"
    "Я не стал распинаться на тему того, нужно ли их вообще знакомить."
    D "Точно не завтра, завтра у меня собес."
    y "Ага, важный день."
    D "Подожди, а ты случайно не по реферальной системе меня устроить хочешь?"
    y 3-2 "..."
    y 1-1 "Ладно, ты меня раскусил, тебя устроит 30 процентов?"
    D "Половина."
    y 1-2 "Сорок пять."
    D "Шестьдесят."
    y 2-1 "Куда-то ты не туда пошёл."
    D "Восемьдесят."
    y 1-4 "Ладно, пополам."
    D "Вот и договорились!"
    y 1-7 "Надо было тебя на рынке устроить."
    D "О, я бы и сам с радостью устроился."
    D "Время уже позднее, я спать пошёл."
    y 1-4 "Ой, мне тоже надо, завтра в семь я тебя разбужу."
    D "В семь? Господи ..."
    y 1-7 "Работа, что с неё взять."
    D "Спокойной ночи."
    hide y with fade
