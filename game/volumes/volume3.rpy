...
label v3_s6:
    ...
    y "Ого, кто-то решил серьёзно заняться личной жизнью?"
    D "Максимализм этот твой ..."
    y "Да ладно тебе, шучу, просто шучу."
    ...
    y "Быстро ты ..."
    y "Ой, тебе наверное забить его надо на кнопку?"
    D "Саня уже забил."
    y "Когда знакомить будешь?"
    ...
    y "Ладно, ты меня раскусил, тебя устроит 30 процентов?"
    D "Половина."
    y "Сорок пять."
    D "Шестьдесят."
    y "Куда-то ты не туда пошёл."
    D "Восемьдесят."
    y "Ладно, пополам."
    D "Вот и договорились!"
    y "Надо было тебя на рынке устроить."
    D "О, я бы и сам с радостью устроился."
    D "Время уже позднее, я спать пошёл."
    y "Ой, мне тоже надо, завтра в семь я тебя разбужу."
    D "В семь? Господи ..."
    y "Работа, что с неё взять."
    D "Спокойной ночи."
