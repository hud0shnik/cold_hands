...
label v1_s3_mind:
    ...
    menu:
        ...
        "Отличная идея":
            ...
            y 3-4 "Окей, раз это не ложки, то наверное ты пришёл ругать меня за эклеры, да?"
        ...
        "Не, играть буду с Саней попозже":
            ...
            s "Ого, как необычно. Даня лежит на кровати и думает. Давно такого не было."
            D "Вот этот твой пассивно-агрессивный сарказм...... Как бы так сказать..."
            s 2-1 "Да понял я, понял. Ты шашки взял?"
            D "Нет, мы вчера с Яной играли, так что возьми у неё."
            s "Окей, пойду спрошу."
            hide sn with fade
            "Саня идёт в соседнюю комнату, спустя пару минут возвращается с шашками."
...
label v1_s4:
    ...
    menu:
        "Погода хорошая, можно и подольше погулять":
            ...
            s 1-5 "Даже не знаю хорошо это или плохо. Ну, раз уж об этом разговор, как тебе?"
            ...
            s 2-2 "Ну ладно, ладно, а каким ты пользуешься?"
            D "Понятия не имею. Я просто говорю Яне взять тот, который до этого был."
            s 2-1 "Ладно, когда буду у тебя дома, посмотрю."
            ...
            s 1-1 "Ха-ха-ха, ну, весьма логично. Я бегал курсовую печатать. Препод наконец-то дал зелёный свет."
            D "Как оценил?"
            s 1-3 "Незаслуженный \"хор\"."
            D "Неплохо..."
            s 1-5 "\"Неплохо\"?!?! Да я целый месяц убил на него. Знаешь за что препод снизил оценку на балл?"
            D "Валяй."
...
label v1_s5:
    ...
    s 3-4 "А как жеш. Тебе как обычно, по минимуму?"
    ...
    s 1-2 "В общем я планирую позвать человек пятнадцать, все скидываются, но так как я тебе должен, можешь не скидываться."
    ...
    s 1-4 "Ну, пара человек на примете есть, если ты об этом. Есть даже одна девушка шахматистка. Кстати вот ты и подставился."
