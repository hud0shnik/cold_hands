...
label v1_s4:
    ...
    play sound door
    play music traffic
    show sn 2-1 at left2 with fade
...
label v1_s5:
    ...
    "Также на доске есть наклейки на черных клетках, что делает их больше. Это не сильно помогает, так как во время партий, я обычно держу ситуацию на столе у себя в голове."
    ...
    D "Ладно, я пойду уже, проводишь?"
    s 2-4 "Конечно! Только шашки соберу."
    hide sn with moveoutleft
    show sn 2-4 at center with moveinleft
    "Саня собирает шашки, отдаёт их мне вместе с ветровкой."
    play sound door
    play music traffic
    show sn 2-4 at left2 with fade
    "Мы идём вместе до моей квартиры обсуждая сегодняшние партии."
