...
label v2_s5_camp:
    ...
    "\" Опять этот лес и ваш беспредел\"."
...
label v2_s5_fear:
    ...
    "\"Не раскидать по саду. Не растерять повсюду.\""
    "Ладно, этот сюжет нужно обдумать."
...
label v2_s6:
    ...
    y "Нет, не переживай. Эклеры я теперь без тебя есть не буду."
    ...
    y "Немного не очень полезной информации. Первые две главы в книга обычно самые скучные. Предисловие, кто такой автор и прочее."
    D "Классика. Я обычно начинал читать книгу со второй главы."
    y "А так разве можно? Вдруг там что-то очень важное."
    if mindPoints >= 2:
