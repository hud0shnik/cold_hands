...
label v2_s2_mind:
    ...
    menu:
        ...
        "О людях":
            ...
            "Ну серьёзно, взять пару любых студентов. Допустим в метро. О чём же они будут говорить?"
            "Об играх или учёбе. Всё. Две темы. То, что происходит с ними в вузе и то, во что они играют."
            "Возьмём двух студенток. Тут всё ещё проще. Разговоры об учёбе и личной жизни."
            ...
            "Да, они не всегда могли поддержать разговор, но мне было достаточно того, что они меня слушают. И, да, я понимал, что выгляжу странно, и ожидаю многого от школьников."
            ...
            "Неужели я остался один на этой планете тупых ...... Ладно, проехали."
            "Как обычно злюсь только из-за того, что не смог найти человека, похожего на меня."
            "Хоть я и понимаю, что никогда такого человека не найду, не нужно лишний раз лишать себя нервных клеток."
            $ coldPoints += 1
...
label v2_s3:
    ...
    D "Ну я серьёзно."
    s "Какие конкурсы, Дань? Это просто обмывание сдачи курсовой. Никаких вписок, тусовок и прочего."
    D "Эх, жаль, а так хотелось..."
    s "Могу турнир по шашкам устроить, но вряд ли у тебя будет на это время."
    D "Это ещё почему?"
    s "Потому что из парней будем только ты, я и трое одногруппников."
    D "А всего человек?"
    s "Минимум десять."
    ...
    "Следующие два часа мы проводим просто беседуя о насущном. Весьма приятно осознавать, что Саня не переживает о завтрашнем дне. Хотя не его плечах организация всего этого."
    ...
    menu:
        ...
        "Лучше просто полежу":
                ...
                "Как иронично, теперь аудиокниги - мой единственный выбор. Хотя, я и не против. В художественной литературе есть одна очень приятная особенность. Ты используешь своё воображение для визуализации."
                "Герои и локации выглядят так, как ты хочешь (с поправкой на описание от автара). Жалко только, что я не могу придумать голоса для персонажей так как текст за меня читает группа озвучки."
                ...
                "Эти размышления сначала опечаливают меня, потом это перерастает в агрессию."
                $ coldPoints += 1
